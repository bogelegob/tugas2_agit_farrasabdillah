...
public class Kopi {
    ...
    public static class RabbitMQConfig {
        ...
        @Bean
        Queue emailQueue() {
            return QueueBuilder.durable("abdiQueue").build();
        }
        @Bean
        DirectExchange rabbitExchange() {
            return new DirectExchange("abdiExchange");
        }
        @Bean
        Binding notifEmailBinding() {
            return BindingBuilder.bind(emailQueue()).to(rabbitExchange()).with("abdi008");
        }
    ...
    public static class RabbitMQConsumer {
        ...
        @RabbitListener(queues = "abdiQueue")
    ...
    public static class ScheduledTask {
        ...
        public void performTask() {
            bumbuKopi.sendMessage("Abdi berhasil consume message");
        }
    }
